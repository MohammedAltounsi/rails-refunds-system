...
# docker build -t rails_refunds_payouts_ledger .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name rails_refunds_payouts_ledger rails_refunds_payouts_ledger
